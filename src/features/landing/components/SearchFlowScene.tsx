            ...
            <div className="grid gap-4 lg:grid-cols-[1.25fr_0.95fr]">
              <div className="space-y-2">
                {showResultRow ? (
                  <>
                    ...
                    >
                      <DemoBookCover className="h-16 w-12" />
                    ...
                    {Array.from({ length: 3 }).map((_, i) => (
                      <div
                        key={i}
                        className="flex items-center gap-3 px-2 py-2 opacity-40"
                      >
                        <div className="border-border-default bg-bg-surface-subtitle h-16 w-12 rounded-md border border-dashed" />
                        <div className="flex-1 space-y-2">
                          <div className="bg-bg-surface-subtitle h-3 w-24 rounded" />
                          <div className="bg-bg-surface-subtitle h-2 w-16 rounded" />
                        </div>
                        <div className="border-border-default bg-bg-surface-subtitle h-8 w-8 rounded border border-dashed" />
                      </div>
                    ))}
                  </>
                ) : null}
              ...
              <div className="hidden flex-col justify-start gap-5 overflow-hidden px-1 lg:flex lg:px-2">
                <div className="flex justify-center pt-1">
                  <DemoBookCover className="h-48 w-32 rounded-lg" />
                </div>
